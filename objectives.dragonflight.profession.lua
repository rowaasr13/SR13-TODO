...
local source_data = {
   [Enum.Profession.Mining] = {
      ...
      item_weekly = {
         ...
         { loot_6 = { quest_id = 72165, item_id = 201300, loot_source = "Nodes" } },
         { treatise = { quest_id = 74106, item_id = 194708, loot_source = "Scribe" } },
      },
   ...
   [Enum.Profession.Herbalism] = {
      ...
      item_weekly = {
         { treatise = { quest_id = 74107, item_id = 194704, loot_source = "Scribe" } },
      },
   ...
   [Enum.Profession.Leatherworking] = {
      ...
      factions_weekly = {
         ...
         { dream_fibrous_thread = { quest_id = 77946 } },
      },
      item_weekly = {
         ...
         { treatise = { quest_id = 74113, loot_source = "Scribe" } },
      },
      valdrakken_orders = { { only_one = {  quest_id = 70594 } } },
   ...
   [Enum.Profession.Alchemy] = {
      ...
      item_weekly = {
         ...
         { treatise = { quest_id = 74108, item_id = 194697, loot_source = "Scribe" } },
      },
   ...
   [Enum.Profession.Tailoring] = {
      ...
      item_weekly = {
         ...
         { treatise =   { quest_id = 74115, item_id = 194698, loot_source = "Scribe" } },
      },
   ...
   [Enum.Profession.Inscription] = {
      ...
      factions_weekly = {
         ...
         { dream_burning_runes = { quest_id = 77914 } },
      },
      item_weekly = {
         ...
         { treatise = { quest_id = 74105, item_id = 194699, loot_source = "Scribe" } },
      },
   ...
   [Enum.Profession.Jewelcrafting] = {
      ...
      item_weekly = {
         ...
         { treatise = { quest_id = 74112, item_id = 194703, loot_source = "Scribe" } },
      },
   ...
   [Enum.Profession.Blacksmithing] = {
      ...
      item_weekly = {
         ...
         { treatise = { quest_id = 74109, item_id = 198454, loot_source = "Scribe" } },
      },
   ...
   [Enum.Profession.Enchanting] = {
      ...
      factions_weekly = {
         ...
         { dream_enchanted_shrubs = { quest_id = 77910 } },
      ...
      item_weekly = {
         ...
         { treatise = { quest_id = 74110, item_id = 194702, loot_source = "Treatise" } },
      },
